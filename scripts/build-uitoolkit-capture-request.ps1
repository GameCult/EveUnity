param(
  ...
  [string] $SurfaceId = "",
  [string] $OutputPath = "artifacts\uitoolkit-capture\request.json",
  [string] $Stamp = "latest"
)

$ErrorActionPreference = "Stop"
$repoRoot = Split-Path -Parent $PSScriptRoot
$capabilityPath = Join-Path $repoRoot "packages\org.gamecult.eve.unity-uitoolkit\eve-runtime-capability.json"
