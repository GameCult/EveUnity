...
namespace GameCult.Eve.UnityScene
{
        ...
        IEveUnityNavigableProvider
    {
        ...
        private sealed class PreparedProvider
        {
            public PreparedProvider(
            ...
            public EveUnityCultMeshProviderSelection Selection { get; }
            public EveUnityCultMeshLiveProviderTransport Transport { get; }
            public EveUnitySceneLiveProviderBridge Bridge { get; }
        }

        private sealed class PreviousProvider
        {
            public PreviousProvider(
                EveUnityCultMeshProviderSelection? selection,
                EveUnityCultMeshLiveProviderTransport? transport,
                EveUnitySceneLiveProviderBridge? bridge,
            ...
            public string VerseFilter { get; }
            public string ProviderFilter { get; }
            public string SurfaceFilter { get; }
            public string SurfaceKind { get; }
            public CultMeshAuthorityTrustPolicy AuthorityTrust { get; }
        }
    }
}
